...
class PlaneWidgetEditor(html.Div):
    def __init__(self, pv_filter, title: str, namespace: str = ""):
        ...
        self.state[self.show_key] = False
        self.state.change(self.show_key)(self._show)
    ...
    def _build_ui(self):
        with self, vuetify.VCard(title=self.title, outlined=True):
            vuetify.VCheckbox(
                v_model=self.show_key,
                label="Show",
                hide_details=True,
    ...
    def set_source(self, source):
        ...
        self._show(self.state[self.show_key])
